...
- Python-скрипты совместимы с Python 3.9+.
...
- [x] Реализовать расширенные настройки плагина:
    - [x] UI для загрузки и выбора фонов (лето, зима, всесезон), шрифтов.
...
- [x] Создать requirements.txt с зависимостями (rembg, pillow, pyyaml, jsonschema, loguru и т.д.)
...
- [x] Принимать и использовать параметры из настроек WP (фон, шрифты, цвета, размеры).
...
- [x] Использовать разные фоны в зависимости от сезона (лето, зима, всесезон).
